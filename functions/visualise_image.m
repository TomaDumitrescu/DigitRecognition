...
function im = visualise_image (train_mat, number)
  ...
  % se citeste din matricea de antrenament linia cu numarul number.
  line(1:n) = train_mat(number, 1:n);

  % se transforma linia citita intr-o matrice 28x28 care trebuie apoi
  % transpusa.
